...
export default function HomePage() {
  ...
  const dataDone = () => {
    axios.get("https://todo-backend-30x6.onrender.com/todos/Done").then((res) => setDonedata(res.data));
  }
  const dataTodo = () => {
    axios.get("https://todo-backend-30x6.onrender.com/todos/To_Do").then((res) => setToDoData(res.data));
  }
  const dataDoing = () => {
    axios.get("https://todo-backend-30x6.onrender.com/todos/Doing").then((res) => setDoingdata(res.data));
  }

  const handleDoing = (e) => {
    axios.patch(`https://todo-backend-30x6.onrender.com/todos/${e.target.value}`, {
      "task": "Doing"
  ...
  const handleDeleteCard = (a) => {
    axios.delete(`https://todo-backend-30x6.onrender.com/todos/${a}`).then((res) => alert("Card Deleted Successfully")).then(() => { dataDoing(); dataDone(); dataTodo() })
